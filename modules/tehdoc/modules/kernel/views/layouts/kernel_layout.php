      ...
      'items' => [
          ...
          [
              ...
              'items' => [
                  ...
                  ['label' => 'По категориям', 'url' => ['/tehdoc/kernel/equipment/categories']],
                  ['label' => 'По месту размещения', 'url' => ['/tehdoc/kernel/equipment/placement']],
                  '<li class="divider"></li>',
                  '<li class="dropdown-header" style="font-size: 10px">Пользовательские</li>',
                  ['label' => 'Классификатор', 'url' => ['/tehdoc/kernel/equipment/classifiers']],
              ],
          ],
