...
<script>
  ...
  jQuery(function ($) {
    var main_url = '/vks/control/vks-place/places';
    var move_url = '/vks/control/vks-place/move';
    var create_url = '/vks/control/vks-place/vks-place-create';
    var update_url = '/vks/control/vks-place/update';
