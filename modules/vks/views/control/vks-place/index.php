...
$about = "Панель управления местами проведения ВКС. При сбое, перезапустите форму, воспользовавшись соответствующей клавишей.";
...
<div class="row">
    ...
    <div class="col-lg-7 col-md-7" style="padding-bottom: 10px">
        ...
        <div class="row" style="padding: 0 15px">
            <div style="border-radius:2px;padding-top:40px">
                ...
                echo \wbraganca\fancytree\FancytreeWidget::widget([
                    'options' => [
                        'source' => [
                            'url' => '/vks/control/vks-place/places',
                        ],
                    ...
                    $.get("/vks/control/vks-place/move", {item: data.otherNode.data.id, action: data.hitMode, second:
                    ...
                    data.otherNode.moveTo(node, data.hitMode);
                      ...
                      data.save;
                        ...
                        if (data.isNew){
                            $.ajax({
                              url: "/vks/control/vks-place/vks-place-create",
      ...
      //                          node.setTitle(result.acceptedTitle);
                            ...
                            $.ajax({
                              url: "/vks/control/vks-place/update",
...
<script>
    ...
    $(document).ready(function () {
        $('.add-category').click(function (event) {
            ...
            $.ajax({
                url: "/vks/control/vks-place/create-root",
                data: {title: 'Новое место ВКС'}
            })
                .done(function () {
                    tree.reload();
                })
    ...
    $(document).ready(function () {
        $('.del-root').click(function (event) {
            ...
            if (confirm('Вы уверены, что хотите удалить выбранный классификатор вместе с вложениями?')) {
                ...
                $.ajax({
                    url: "/vks/control/vks-place/delete-root",
                    type: "post",
        ...
        $('.del-node').click(function (event) {
            if (confirm('Вы уверены, что хотите удалить выбранный классификатор?')) {
                ...
                var node = $(".ui-draggable-handle").fancytree("getActiveNode");
                $.ajax({
                    url: "/vks/control/vks-place/delete",
                    type: "post",
                    data: {id: node.data.id, _csrf: csrf}
                })
                    .done(function () {
