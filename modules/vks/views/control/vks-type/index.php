...
<div class="row">
    ...
    <div class="col-lg-7 col-md-7" style="padding-bottom: 10px">
        ...
        <div class="row" style="padding: 0 15px">
            <div style="border-radius:2px;padding-top:40px">
                ...
                echo \wbraganca\fancytree\FancytreeWidget::widget([
                    'options' => [
                        'source' => [
                            'url' => '/vks/control/vks-type/types',
                        ],
                    ...
                    $.get("/vks/control/vks-type/move", {item: 
                            data.otherNode.data.id, 
                            action: data.hitMode, 
                            second: node.data.id
                        },function(){
                    data.otherNode.moveTo(node, data.hitMode);
                      ...
                      data.save;
                        ...
                        if (data.isNew){
                            $.ajax({
                              url: "/vks/control/vks-type/vks-type-create",
      ...
      //                          node.setTitle(result.acceptedTitle);
                            ...
                            $.ajax({
                              url: "/vks/control/vks-type/update",
