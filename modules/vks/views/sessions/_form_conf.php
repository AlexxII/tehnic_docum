...
<div class="col-lg-7 col-md-7" style="border-radius:2px;padding-top:10px">
  ...
  <div class="form-group">
    ...
    <div class="form-group col-md-12 col-lg-9" style="padding: 0px">
      <div class="form-group">
        <div class="form-group col-md-6 col-lg-6">
          <?= $form->field($model, 'vks_teh_time_start')->textInput(['class' => 'time-mask form-control right'])
            ->hint('', ['class' => ' w3-label-under']); ?>
        </div>
        <div class="form-group col-md-6 col-lg-6">
          <?= $form->field($model, 'vks_teh_time_end')->textInput(['class' => 'time-mask form-control'])
            ->hint('', ['class' => ' w3-label-under']); ?>
        </div>
      </div>
    </div>
    ...
    <div class="form-group col-md-12 col-lg-9" style="padding: 0px">
      <div class="form-group">
        <div class="form-group col-md-6 col-lg-6">
          <?= $form->field($model, 'vks_work_time_start')->textInput(['class' => 'time-mask form-control right'])
            ->hint('', ['class' => ' w3-label-under']); ?>
        </div>
        <div class="form-group col-md-6 col-lg-6">
          <?= $form->field($model, 'vks_work_time_end')->textInput(['class' => 'time-mask form-control'])
            ->hint('', ['class' => ' w3-label-under']); ?>
        </div>
      </div>
    </div>
    ...
    <div class="form-group">
      <div class="form-group col-md-5 col-lg-5">
        ...
        ])->dropDownList($model->vksTypesList, [
      ...
      <div class="form-group col-md-7 col-lg-7">
        ...
        ])->dropDownList($model->vksPlacesList, [
          'prompt' => ['text' => 'Выберите',
            'options' => [
              'value' => 'none',
              'disabled' => 'true',
    ...
    <div class="col-md-12 col-lg-12"
      ...
      <div class="form-group col-md-7 col-lg-7">
        <?= $form->field($model, 'vks_subscriber_mur_office', [
          'template' => '{label} <sup class="h-title fa fa-info-circle nonreq" aria-hidden="true"
                data-toggle="tooltip" data-placement="top" title="' . $vks_subscrof_hint . '"></sup>{input}{hint}'
        ])->dropDownList($model->vksRegionSubscribesList, ['id' => 'subscriber-mur-office', 'data-name' => 'vks_subscriber_mur_office',
          'prompt' => ['text' => 'Выберите',
            'options' => [
              'value' => 'none',
              'disabled' => 'true',
    ...
    <div class="form-group col-md-12 col-lg-12">
      <?= $form->field($model, 'vks_equipment', [
        'template' => '{label} <sup class="h-title fa fa-info-circle nonreq" aria-hidden="true"
                data-toggle="tooltip" data-placement="top" title="' . $vks_subscrof_hint . '"></sup>{input}{hint}'
      ])->dropDownList($model->vksRegionSubscribesList, ['data-name' => 'vks_equipment',
        'prompt' => ['text' => 'Выберите',
          'options' => [
            'value' => 'none',
            'disabled' => 'true',
