...
<div class="col-lg-7 col-md-7" style="border-radius:2px;padding-top:10px">
    ...
    <div class="form-group">
        ...
        <div class="form-group col-md-12 col-lg-9" style="padding: 0px">
            <div class="form-group">
                <div class="form-group col-md-6 col-lg-6">
                    <?= $form->field($model, 'vks_teh_time_start')->textInput(['class' => 'time-mask form-control right'])->hint('', ['class' => ' w3-label-under']); ?>
                </div>
                <div class="form-group col-md-6 col-lg-6">
        ...
        <div class="form-group col-md-12 col-lg-9" style="padding: 0px">
            <div class="form-group">
                <div class="form-group col-md-6 col-lg-6">
                    <?= $form->field($model, 'vks_work_time_start')->textInput(['class' => 'time-mask form-control right'])->hint('', ['class' => ' w3-label-under']); ?>
                </div>
                <div class="form-group col-md-6 col-lg-6">
        ...
        <div class="col-md-12 col-lg-12"
             style="border: dashed 1px #0c0c0c;border-radius: 4px;padding: 10px 0px;margin-bottom: 10px">
            <div class="form-group col-md-7 col-lg-7">
