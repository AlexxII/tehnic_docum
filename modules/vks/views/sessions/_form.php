...
<div>
    ...
    <div class="col-lg-5 col-md-4"
        ...
        <div class="form-group col-md-12 col-lg-12">
            ...
            ])->dropDownList($model->vksEmployeesList, ['data-name' => 'vks_employee_send_msg', 'prompt' => ['text' => 'Выберите', 'options' => ['value' => 'none', 'disabled' => 'true', 'selected' => 'true']]])->hint('', ['class' => ' w3-label-under']);
            ?>
