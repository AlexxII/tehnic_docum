...
<div class="clsf-extender">
  <form action="tested" method="post" class="input-add">
    ...
    <input class="form-control clsf-name" name="clsf-name" disabled title="Вводите имя в колонке дерева классификаторов. Клавиша F2 или двойной щелчок мыши"
    ...
    <button type="submit" class="btn btn-primary save-btn insert-btn-cls" onclick="saveClick(event)">Создать</button>
  </form>
</div>
